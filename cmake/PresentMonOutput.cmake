...
function(pmon_configure_output_directories)
    ...
    if(NOT generator_platform AND CMAKE_VS_PLATFORM_NAME)
        set(generator_platform "${CMAKE_VS_PLATFORM_NAME}")
    endif()

    if(generator_platform STREQUAL "Win32")
        set(pmon_architecture "Win32")
        set(pmon_arch_tag "x86")
    elseif(generator_platform STREQUAL "x64")
        set(pmon_architecture "x64")
        set(pmon_arch_tag "x64")
    else()
        message(
            FATAL_ERROR
            "Unsupported generator platform: ${generator_platform}. "
            "Use x64 or Win32."
        )
    endif()
