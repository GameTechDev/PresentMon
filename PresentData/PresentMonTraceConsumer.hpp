    ...
    struct PsoCompileActivityKey {
        ...
        bool operator==(const PsoCompileActivityKey& other) const
        {
            return processId == other.processId &&
                activityId.Data1 == other.activityId.Data1 &&
                activityId.Data2 == other.activityId.Data2 &&
                activityId.Data3 == other.activityId.Data3 &&
                memcmp(activityId.Data4, other.activityId.Data4, sizeof(activityId.Data4)) == 0;
        }
    };
