...
enum PresentMonProvider_FrameType {
    ...
    PresentMonProvider_FrameType_AMD_FSR_FG = 101,  // Frame generated by AMD FSR Frame Generation.
    PresentMonProvider_FrameType_NVIDIA_DLSS = 150, // Frame generated by NVIDIA DLSS.
};
