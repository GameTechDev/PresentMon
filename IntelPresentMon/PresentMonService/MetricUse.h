...
// NOTE: This file must remain header-only because ControlLib depends on these
// types even though ControlLib does not have a symbol link dependency on the
// PresentMonService project.
