...
#define METRIC_LIST(X_) \
		...
		X_(PM_METRIC_CPU_POWER_LIMIT, PM_METRIC_TYPE_STATIC, PM_UNIT_WATTS, PM_DATA_TYPE_DOUBLE, PM_DATA_TYPE_DOUBLE, 0, PM_DEVICE_TYPE_SYSTEM, PM_STAT_MID_POINT) /* maybe stat NONE? */ \
