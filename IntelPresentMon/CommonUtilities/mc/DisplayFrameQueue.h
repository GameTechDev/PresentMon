...
namespace pmon::util::metrics
{
    ...
    private:
        ...
        // Generated rows after an app anchor, until the next app anchor closes the
        // interval. Not yet animation-complete.
        std::vector<PendingRow> openAppToAppIntervalRows_;
        ...
        // Not-displayed rows held while an app anchor exists. Not yet animation-complete.
        std::deque<PendingRow> notDisplayedRowsHeldForIntervalRelease_;
